<?php 
    ...
    // $db->runSQL("INSERT INTO tblkategori VALUES ('', 'Ikan Goreng')");

    // $db->runSQL("DELETE FROM tblkategori WHERE idkategori = 35");

    // $row = $db->getITEM("SELECT * FROM tblkategori WHERE idkategori = 16");
